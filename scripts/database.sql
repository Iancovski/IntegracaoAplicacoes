...
ALTER TABLE MOVIMENTACAO ADD CONSTRAINT MOVIMENTACAO_fk0 FOREIGN KEY (ID_FORNECEDOR) REFERENCES TERCEIRO(ID);
ALTER TABLE MOVIMENTACAO ADD CONSTRAINT MOVIMENTACAO_fk1 FOREIGN KEY (ID_CLIENTE) REFERENCES TERCEIRO(ID);
ALTER TABLE MOVIMENTACAO ADD CONSTRAINT MOVIMENTACAO_fk2 FOREIGN KEY (ID_VENDEDOR) REFERENCES TERCEIRO(ID);
ALTER TABLE MOVIMENTACAO_PRODUTO ADD CONSTRAINT MOVIMENTACAO_PRODUTO_fk0 FOREIGN KEY (ID_MOVIMENTACAO) REFERENCES MOVIMENTACAO(ID);
ALTER TABLE MOVIMENTACAO_PRODUTO ADD CONSTRAINT MOVIMENTACAO_PRODUTO_fk1 FOREIGN KEY (ID_PRODUTO) REFERENCES PRODUTO(ID);